...
class FoldersController extends Controller
{
     ...
     public function show_pic($id)
    {
        ...
        return view('admin.folders.show_pic', compact('folder', 'created_bies'));
    }
    ...
    public function search(){
       ...
       $folders = Folder::where($field,$searchText)->get();
       return view('admin.folders.search', compact('folders'));
