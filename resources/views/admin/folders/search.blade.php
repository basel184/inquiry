...
@section('content')
    <h3 class="page-title">@lang('نتيجة البحث')</h3>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table id="myTable" class="table table-bordered  {{ count($folders) > 0 ? 'datatable' : '' }} @can('folder_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                <tr>
                    @can('folder_delete')
        ...
        'route' => ['admin.folders.perma_del', $folder->id])) !!}
                ...
                @else
                    <tr>
                        <td colspan="7">@lang('لا يوجد نتيجة للبحث ')</td>
                    </tr>
                @endif
                </tbody>
            </table>
