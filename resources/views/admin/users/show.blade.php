...
@section('content')
    <h3 class="page-title">@lang('المستخدمين')</h3>
...
<li role="presentation" class="active"><a href="#folders" aria-controls="folders" role="tab" data-toggle="tab">الأستعلامات</a></li>
<!-- <li role="presentation" class=""><a href="#files" aria-controls="files" role="tab" data-toggle="tab">الملفات</a></li> -->
</ul>
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.users.index') }}" class="btn btn-default">@lang('جميع المستخدمين')</a>
        </div>
